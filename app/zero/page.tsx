...
import HashratePage from "@/app/hashrate/page"
      ...
      return (
        ...
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-3 pl-20 pr-20 pb-5">
                            ...
                            <Card >
                                    ...
                                    <CardContent>
                                        <div className="text-2xl font-bold text-[#ff9e00]">
                                        {cfuHashRateInPH.toFixed(2)} PH/s
                                        </div>
                                    </CardContent>
                                    </Card>
                                                <Card >
                                                ...
                                                <CardContent>
                                                    <div className="text-2xl font-bold text-[#ff9e00]">
                                                    {cfuPowerDraw.toFixed(2)} MW's
                                                    </div>
                                                </CardContent>
                                                </Card>
                                                
        </div>
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2 pl-20 pr-20 pb-5">
        <HashratePage />
        <HashratePage />
        </div>
